...
const Login = () => {
    ...
    return (
        <div className="min-h-screen bg-cover bg-[url(https://res.cloudinary.com/dyyy9djvx/image/upload/v1751125716/background_image_fvpfcp.jpg)] flex items-center justify-center p-4">
