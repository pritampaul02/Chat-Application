...
const ChatScreen = () => {
  return (
    <div className="flex flex-col h-screen flex-1 justify-between">
          ...
          <div className="w-[45%] flex items-center  gap-2  h-auto p-4">
            ...
            <div className="w-auto h-auto flex gap-2 flex-col ">
              ...
              <div className="h-auto relative bg-[#FFFFFF] border p-3 border-[#E7E7E7]">
                minima delectus facilis temporibus vitaeminima delectus faciecessitatibus
                suscipit.minima delectus faciecessitatibus suscipit.minima delectus
                faciecessitatibus suscipit.minima delectus faciecessitatibus suscipit.minima
                delectus faciecessitatibus suscipit.minima delectus faciecessitatibus
                suscipit.minima delectus faciecessitatibus suscipit.minima delectus
                faciecessitatibus suscipit. eaque necessitatibus suscipit.
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="h-[5rem] flex items-center justify-between w-full gap-2 p-2  bg-white border-1   border-[#DFDFDF] ">
